...
import img10 from './assets/Specialist.jpg'
import { isMobile } from 'react-device-detect';

function SpecialistExam(props) {
    ...
    let handleClickGetMenu = (e) => {
        ...
        // console.log('=====specialist:', e.target.textContent)
    }
            ...
            {!isMobile &&
                <div className={menuBar ? 'ads-article-left-content ads-article-left-content--open' : 'ads-article-left-content'}>
                    ...
                    <div className="ads-article-left-contact">
                        <h2><FormattedMessage id="articles.specialist.header3" /></h2>
                        <p><FormattedMessage id="articles.specialist.p6" /></p>
                        <ul className="contact">
                            <span><i className="fa fa-envelope"></i> &nbsp; information@untitled.tld</span>
                            <span><i className="fa fa-phone"></i>&nbsp; (000) 123-1234</span>
                            <span><i className="fa fa-home"></i>&nbsp; 1234 Somewhere Road #8254<br />
                                &nbsp; Calgary, T0B 0C0</span>
                        </ul>
                    </div>
                </div>
            }
            <div className={menuBar ? 'ads-article-right-content' : 'ads-article-right-content  ads-article-right-content--open'}>
                <div className="ads-article-right-header">
                    <div className='aar-header-content'>
                        <span className='aar-header-text'>
                            <FormattedMessage id="home-header.specialist-exam" />
                        </span >
                        {!isMobile &&
                ...
                <div className={!isMobile ? "ads-article-right-body" : "ads-article-right-body-mobile"}>
                    <div className="aar-body-text">
                        <h1><FormattedMessage id="home-header.specialist-exam" /></h1>
                        <p className='p1'><FormattedMessage id="articles.specialist.header" /></p>
                        <p className='p2'><FormattedMessage id="articles.specialist.p1" /></p>
                    </div>
                ...
                <div className={!isMobile ? "ads-article-right-footer" : "ads-article-right-footer-mobile"}>
                    <div className="aar-footer-title">
                        <h1><FormattedMessage id="articles.specialist.header2" /></h1>
                    </div>
                    <div className="aar-footer-content">
                        ...
                        <div className="aar-footer-content-text1">
                            <h3><FormattedMessage id="articles.specialist.ph2" /></h3>
                            <p><FormattedMessage id="articles.specialist.p2" /></p>
                        </div>
                        <div className="aar-footer-content-text2">
                            <h3><FormattedMessage id="articles.specialist.ph3" /></h3>
                            <p><FormattedMessage id="articles.specialist.p3" /></p>
                        </div>
                        <div className="aar-footer-content-text3">
                            <h3><FormattedMessage id="articles.specialist.ph4" /></h3>
                            <p><FormattedMessage id="articles.specialist.p4" /></p>
                        </div>
                        <div className="aar-footer-content-text4">
                            <h3><FormattedMessage id="articles.specialist.ph5" /></h3>
                            <p><FormattedMessage id="articles.specialist.p5" /></p>
                        </div>
                    </div>
                </div>
            </div>
