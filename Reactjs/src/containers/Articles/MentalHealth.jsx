...
import img10 from './assets/mental.jpg'
            ...
            {!isMobile &&
                <div className={menuBar ? 'ads-article-left-content ads-article-left-content--open' : 'ads-article-left-content'}>
                    ...
                    <div className="ads-article-left-contact">
                        <h2><FormattedMessage id="articles.mental.header3" /></h2>
                        <p><FormattedMessage id="articles.mental.p6" /></p>
            ...
            <div className={menuBar ? 'ads-article-right-content' : 'ads-article-right-content  ads-article-right-content--open'}>
                ...
                <div className={!isMobile ? "ads-article-right-body" : "ads-article-right-body-mobile"}>
                    <div className="aar-body-text">
                        <h1><FormattedMessage id="home-header.mental-health" /></h1>
                        <p className='p1'><FormattedMessage id="articles.mental.header" /></p>
                        <p className='p2'><FormattedMessage id="articles.mental.p1" /></p>
                    </div>
                ...
                <div className={!isMobile ? "ads-article-right-footer" : "ads-article-right-footer-mobile"}>
                    <div className="aar-footer-title">
                        <h1><FormattedMessage id="articles.mental.header2" /></h1>
                    </div>
                    <div className="aar-footer-content">
                        ...
                        <div className="aar-footer-content-text1">
                            <h3><FormattedMessage id="articles.mental.ph2" /></h3>
                            <p><FormattedMessage id="articles.mental.p2" /></p>
                        </div>
                        <div className="aar-footer-content-text2">
                            <h3><FormattedMessage id="articles.mental.ph3" /></h3>
                            <p><FormattedMessage id="articles.mental.p3" /></p>
                        </div>
                        <div className="aar-footer-content-text3">
                            <h3><FormattedMessage id="articles.mental.ph4" /></h3>
                            <p><FormattedMessage id="articles.mental.p4" /></p>
                        </div>
                        <div className="aar-footer-content-text4">
                            <h3><FormattedMessage id="articles.mental.ph5" /></h3>
                            <p><FormattedMessage id="articles.mental.p5" /></p>
                        </div>
                    </div>
                </div>
            </div>
